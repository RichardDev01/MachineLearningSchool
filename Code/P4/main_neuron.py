...
def sigmoidANDNetwork():
    ...
    print(networkOneAND1)
    # print(networkOneAND1.output_layer_difference([0, 0], [0]))

    networkOneAND1.backpropagation_network([0, 0], [0, 0], 1)
    print(f"\n\n---------after backpropagation--------\n\n{networkOneAND1}")

    networkOneAND1.backpropagation_network([1, 0], [0, 0], 1)
    print(f"\n\n---------after 2 backpropagations--------\n\n{networkOneAND1}")
    # print(networkOneAND1.feed_forward([0, 0]))
...
def sigmoidXOR():
    ...
    # # networkOneXOR.output_layer_difference([0, 0], [0])
    # networkOneXOR.backpropagation_network([1, 1], [0], 1)
    #
    # print(f"\n\n\n------- after 1 training ------\n\n\n{networkOneXOR}")
    # networkOneXOR.backpropagation_network([0, 1], [1], 1)
    #
    # print(f"\n\n\n------- after 2 training ------\n\n\n{networkOneXOR}")
    ...
    for _ in range(0, 100000):
        for index, i in enumerate(table):
            ...
            # print(AND1)
            # print(f"{list(i)=} and {expected_output_and[index][1][0]=}")
            networkOneXOR.backpropagation_network(list(i), expected_output_xor[index][1], 1)
            # AND1.calc_total_loss(expected_output_and, table)
            # print(AND1)
    print("\n\nafter training 1000 epochs and 1 learning rate")
    # print(networkOneXOR)
    # print(layerOneXOR.input_weights())
    for index, i in enumerate(table):
        output = networkOneXOR.feed_forward(list(i))
        print(f'input = {list(i)} and output {output} expected output = {expected_output_xor[index][1]} difference == {expected_output_xor[index][1][0] - output[0]}')
